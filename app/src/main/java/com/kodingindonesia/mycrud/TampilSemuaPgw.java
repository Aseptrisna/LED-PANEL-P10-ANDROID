    ...
    private void showEmployee(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                String name = jo.getString(konfigurasi.TAG_PESAN);

                HashMap<String,String> employees = new HashMap<>();
                employees.put(konfigurasi.TAG_ID,id);
                employees.put(konfigurasi.TAG_PESAN,name);
                list.add(employees);
            }
        ...
        ListAdapter adapter = new SimpleAdapter(
                ...
                new String[]{konfigurasi.TAG_ID,konfigurasi.TAG_PESAN},
                new int[]{R.id.id, R.id.pesan});
