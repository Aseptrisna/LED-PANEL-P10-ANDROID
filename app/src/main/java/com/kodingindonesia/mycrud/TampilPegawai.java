...
public class TampilPegawai extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextName = (EditText) findViewById(R.id.editTextpesan);
        editTextDesg = (EditText) findViewById(R.id.editTextlokasi);
        editTextSalary = (EditText) findViewById(R.id.editTexttanggal);
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TampilPegawai.this,"Sedang Mengambil Data...","Tunggu...",false,false);
            }
    ...
    private void showEmployee(String json){
        try {
            ...
            String name = c.getString(konfigurasi.TAG_PESAN);
            String desg = c.getString(konfigurasi.TAG_LOKASI);
            String sal = c.getString(konfigurasi.TAG_TANGGAL);
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(konfigurasi.KEY_PESAN,name);
                hashMap.put(konfigurasi.KEY_LOKASI,desg);
                hashMap.put(konfigurasi.KEY_TANGGAL,salary);
